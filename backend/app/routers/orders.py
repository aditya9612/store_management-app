...
def create_order(order: schemas.OrderCreate, db: Session = Depends(database.get_db)):
    try:
        ...
        # Load the complete order with customer and items
        complete_order = crud.get_order(db, db_order.id)

        return OnSuccess(data=complete_order, message="Order created successfully")
