...
class OrderItem(Base):
    ...
    product_id = Column(Integer, ForeignKey("products.id"), nullable=True)  # Nullable for manual products
    name = Column(String(255), nullable=True)  # For manual products
    description = Column(String(500), nullable=True)  # For manual products
...
class CompanySettings(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    company_name = Column(String(200), nullable=False, default="Company Inc.")
    company_email = Column(String(100), nullable=False)
    company_phone = Column(String(15), nullable=True)
